function [eye1,eye2]=loadsigspFdata

[~,ipsieyepath]=uigetfile('*.mat','select trace for ipsieye');


eye1=load(fullfile(ipsieyepath,'peakSI.mat'),'run','matrix','window','win_sig','sigspF');
...
eye2=load(fullfile(contraeyepath,'peakSI.mat'),'matrix','window','win_sig','sigspF');
...
[eye1.peakR,eye1.sigR,eye1.errorR,eye1.peakS,eye1.sigS,eye1.errorS]= sigFcmp(eye1.sigspF,eye1.win_sig,eye1.matrix);
[eye2.peakR,eye2.sigR,eye2.errorR,eye2.peakS,eye2.sigS,eye2.errorS]= sigFcmp(eye2.sigspF,eye2.win_sig,eye2.matrix);
