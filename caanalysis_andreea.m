...
day1_rep = [11 149 44 162 146 57 76 80 39 53]; %for 03/29
day2_rep = [78 201 96 119 67 68 57 24 27 4]; %for 04/04
picked = [4 20 19 42 50 49 56 70 64 96];

try
    sigplt_onepage(sig_raw(:,day1_rep),velocity,frame,stimtype,Cor(day1_rep)); %
...
%% plotting
         ...
         caanalysisplot(folder,day1_rep,0); %close all;
